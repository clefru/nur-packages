...
in stdenv.mkDerivation rec {
  ...
  src = fetchzip {
    name = "scripts";
    stripRoot = false;
    url = "http://mirrors.ctan.org/tex-archive/fonts/minionpro/scripts.zip";
    sha256 = "0w5i6r5chf2c2mp3pd8b7as3nl0ri3f43cavxiix0wcv1da1y0lw";
  };
  enc = fetchurl {
    name = "enc";
    url = "http://mirrors.ctan.org/tex-archive/fonts/minionpro/enc-2.000.zip";
    sha256 = "12mwn0409pf7qcigp7alvrwnz8j1zpiv10ihw8jbffdpc97gdfaj";
  };
  metrics = fetchurl {
    name = "metrics";
    url = "http://mirrors.ctan.org/tex-archive/fonts/minionpro/metrics-base.zip";
